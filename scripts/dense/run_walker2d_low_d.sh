...
do
  ...
  EXP_PATH="${LOG_DIR}/imle_baseline/walker2d_dense_rew_x_t1000_enc_tanh/${i}/";
  mkdir -p $EXP_PATH
  python main.py $DEFAULT_ARGS --imle --seed $i --log-dir $EXP_PATH --env-name "Walker2DBulletX-v0"
  #
  # EXP_PATH="${LOG_DIR}/vime_baseline/walker2d_dense_rew/${i}/";
  # mkdir -p $EXP_PATH
  # python main.py $DEFAULT_ARGS --vime --seed $i --log-dir $EXP_PATH --env-name "Walker2DBulletX-v0"
done
