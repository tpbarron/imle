...
DEFAULT_ARGS="--bnn-n-updates-per-step 500 --max-episode-steps 1000 --num-processes 1 --num-steps 2048 --entropy-coef 0 --ppo-epoch 10 --lr 3e-4 --gamma 0.99 --tau 0.95 --batch-size 64 --num-frames 1000000 --num-stack 4 --use-gae"

# no explr
# high dim
for i in 1 2 3 4 5
do
  EXP_PATH="baseline/inverted_pendulum_swingup_vision_dense_rew_t1000/${i}/";
