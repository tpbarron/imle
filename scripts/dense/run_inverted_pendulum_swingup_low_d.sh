...
DEFAULT_ARGS="--bnn-n-updates-per-step 5000 --num-processes 1 --num-steps 2048 --entropy-coef 0 --ppo-epoch 10 --lr 3e-4 --gamma 0.99 --tau 0.95 --batch-size 64 --num-frames 100000 --use-gae"

# no explr
# high dim
for i in 1 2 3 4 5
do
  EXP_PATH="baseline/inverted_pendulum_swingup_dense_rew/${i}/";
...
for i in 1 2 3 4 5
do
  EXP_PATH="imle_baseline/inverted_pendulum_swingup_dense_rew/${i}/";
  mkdir -p "${LOG_DIR}/${EXP_PATH}";
