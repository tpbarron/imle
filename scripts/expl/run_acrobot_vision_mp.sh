LOG_DIR="/home/users/tbarron/Documents/dev/ml/data/outputs/imle/10_30_17/";
...
do
  ...
  mkdir -p $ENV_NAME;
  python main.py $DEFAULT_ARGS --seed $i --log-dir $ENV_NAME --env-name "AcrobotContinuousVisionX-v0" --no-cuda &
