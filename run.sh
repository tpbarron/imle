...
do
  ...
  python main.py $DEFAULT_ARGS --seed $i --log-dir "${LOG_DIR}imle_baseline/chain_vision_x/${i}/" --env-name 'ChainVisionX-v0' --num-stack 4 > "${LOG_DIR}baseline/chain_vision_x/${i}/out.log" 2>&1
